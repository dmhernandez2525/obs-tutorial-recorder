...
A Windows application for automating OBS Studio recordings with ISO (individual source) recording support. Perfect for multi-camera setups with up to 10 cameras.
...
- **10 Camera Support**: Record up to 10 cameras simultaneously
...
3. **Select a profile** (PC-Single or PC-10Cameras)
